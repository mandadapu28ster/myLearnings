...
public class MethodUsageExample {
	...
	public static void main(String[] args) {
		...
		Triangle rect1= new Triangle();												//default;method 6
		...
		Triangle rect2= new Triangle(8.8);										//Constructor example method 5
		System.out.println("Isosles Triangle Area ===>  "+rect2.area());

		Triangle rect3= new Triangle(4.4,3.3);								//Constructor example method 4
		System.out.println("Rectangle Area ===>  "+rect3.area());

		Triangle rect4= new Triangle(rect3);								//Constructor and object passing example method 7
		System.out.println("Rectangle Area ===>  "+rect4.area());
	}
